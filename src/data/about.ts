...
export const about = {
  paragraphs: [
    ...
    'I learned the engineering in industry rather than in a lab. A year and a half at Jacto, one of the world\'s largest manufacturers of agricultural machinery, put me next to after-sales operations at industrial scale and taught me to read a problem from the people who have it before reaching for a model. That is a habit rather than a sector, and it travels to any domain where a wrong answer is paid for by someone outside the room. I finish a technology degree in Big Data for Agribusiness at Fatec Shunji Nishimura in November 2026.',
    'I work at Unipac on an internal platform that turns an approved product specification into a working application through 7 specialist agents and 13 deterministic verifiers. Most of my time there goes to the part after the model works: containment, verification, and the boundaries that decide what generated code is allowed to reach.',
