...
export const about = {
  paragraphs: [
    'I am an AI Engineer bridging two worlds that rarely meet: the commercial reality of global agriculture and the engineering of modern machine learning systems. I build retrieval-augmented and agentic LLM systems in Python, and applied computer vision that runs on the device rather than in a data center.',
