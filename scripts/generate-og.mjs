...
// Identity is duplicated here on purpose: this script is plain .mjs and cannot
// import the TypeScript config, so keep it in sync with src/data/site.ts by hand.
